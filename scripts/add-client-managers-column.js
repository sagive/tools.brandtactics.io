...
async function run() {
  try {
    ...
    const query = "ALTER TABLE public.clients ADD COLUMN IF NOT EXISTS client_managers JSONB DEFAULT '[]'::jsonb;";

    await client.query(query);
    console.log("Migration executed successfully! Added client_managers column to clients table.");
  } catch (err) {
