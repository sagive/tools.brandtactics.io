      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          {filteredCredentials.map((cred, index) => {
            ...
            return (
              <div key={index} className="group p-2 rounded-xl border border-gray-50 bg-white hover:border-blue-100 hover:shadow-sm transition-all relative">
                <Button 
                  variant="ghost" 
                  size="icon" 
                  onClick={() => removeCredentialLine(originalIndex)}
                  className="absolute -right-3 top-1/2 -translate-y-1/2 h-7 w-7 rounded-full bg-white border border-red-100 shadow-sm text-red-500 opacity-0 group-hover:opacity-100 transition-opacity z-10"
                >
                ...
                <div className="grid grid-cols-12 gap-3 items-center">
                  <div className="col-span-3">
                    ...
                    >
                      <SelectTrigger className="h-10 bg-gray-50/50 border-gray-100 text-[11px] hover:shadow-sm transition-all rounded-xl w-full">
                        <SelectValue>
                          {cred.site_id 
                  ...
                  <div className="col-span-3">
                    <Input 
                      ...
                      className="h-10 text-xs bg-gray-50/50 border-gray-100 hover:shadow-sm transition-all rounded-xl w-full"
                    />
                  </div>
                  <div className="col-span-3">
                    <Input 
                      ...
                      className="h-10 text-xs bg-gray-50/50 border-gray-100 hover:shadow-sm transition-all rounded-xl w-full font-mono"
                    />
                  </div>
                  <div className="col-span-3">
                    <div className="relative group/link w-full">
                      ...
                      <Input 
                        ...
                        placeholder="https://..." 
                        className="h-10 text-xs pl-8 bg-gray-50/50 border-gray-100 hover:shadow-sm transition-all rounded-xl w-full truncate"
                      />
                    </div>
                  </div>
                </div>
