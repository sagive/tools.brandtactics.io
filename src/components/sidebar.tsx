...
import { LayoutDashboard, Users, FileText, Mail, Settings, Briefcase, PlusCircle, ChevronRight, ChevronLeft, Menu } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <Button
        variant="ghost"
        size="icon"
        className="absolute -right-4 top-5 h-8 w-8 rounded-full border shadow-sm bg-white hover:bg-gray-50 z-50 flex items-center justify-center"
